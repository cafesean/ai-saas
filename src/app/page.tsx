        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-white shadow rounded-lg p-6">
              ...
              <a href="/roles" className="mt-4 inline-block text-blue-600 hover:text-blue-800">
                View Roles →
              </a>
            </div>
            <div className="bg-white shadow rounded-lg p-6">
              ...
              <a href="/levels" className="mt-4 inline-block text-blue-600 hover:text-blue-800">
                View Levels →
              </a>
            </div>
            <div className="bg-white shadow rounded-lg p-6">
              ...
              <a href="/rate-cards" className="mt-4 inline-block text-blue-600 hover:text-blue-800">
                View Rate Cards →
              </a>
            </div>
          </div>
          <div id="first-chat-widget" className="w-[500px] bg-white rounded-lg h-[250px]" dangerouslySetInnerHTML={{ __html: '' }}>
          </div>
        </div>
      </main>
    </>
