...
export function FineTuneModelDialog({ open, onOpenChange, onFineTune, modelName }: FineTuneModelDialogProps) {
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader>
          ...
          <DialogDescription>
            Customize the model for your specific use case with additional training data.
          </DialogDescription>
        </DialogHeader>
        <div className="grid gap-4 py-4">
          <div className="grid grid-cols-4 items-center gap-4">
            ...
            <div className="col-span-3">
              <Select value={dataset} onValueChange={setDataset}>
                ...
                <SelectContent>
                  <SelectItem value="Customer Support Queries">Customer Support Queries</SelectItem>
                  <SelectItem value="Product Reviews">Product Reviews</SelectItem>
                  <SelectItem value="Social Media Comments">Social Media Comments</SelectItem>
                  <SelectItem value="Email Classification">Email Classification</SelectItem>
                </SelectContent>
              </Select>
            </div>
          </div>
          <div className="grid grid-cols-4 items-center gap-4">
            ...
            <Input id="epochs" value={epochs} onChange={(e) => setEpochs(e.target.value)} className="col-span-3" />
          </div>
          <div className="grid grid-cols-4 items-center gap-4">
        ...
        <DialogFooter>
          ...
          <SampleButton onClick={handleFineTune}>Start Fine-tuning</SampleButton>
        </DialogFooter>
      </DialogContent>
    </Dialog>
  )
