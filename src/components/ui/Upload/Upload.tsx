    ...
    >
      ...
      <div className="grid gap-2">
        ...
        <div className="flex items-center justify-center">
          <label>
            <input type="file" ref={fileInputRef} hidden accept=".txt .pdf" onChange={(e) => doUpload(e)} multiple />
            <div className="flex h-9 w-28 cursor-pointer flex-col items-center justify-center rounded-full bg-indigo-600 px-2 text-xs font-semibold leading-4 text-white shadow focus:outline-none">
              Choose File
            </div>
          </label>
        </div>
